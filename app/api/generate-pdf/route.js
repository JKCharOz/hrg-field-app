...
export async function POST(req) {
  try {
    ...
    + '<tr><td style="font-weight:bold;width:80px;padding:3px 6px;border-bottom:1px solid #ccc">Project:</td><td style="padding:3px 6px;border-bottom:1px solid #ccc;border-right:1px solid #000;width:45%">' + na(project.project_name) + '</td><td style="font-weight:bold;width:110px;padding:2px 4px;border-bottom:1px solid #ccc">Report No:</td><td style="padding:2px 4px;border-bottom:1px solid #ccc">' + na(report.report_number) + '</td></tr>'
    + '<tr><td style="font-weight:bold;padding:3px 6px;border-bottom:1px solid #ccc">Owner:</td><td style="padding:2px 4px;border-bottom:1px solid #ccc;border-right:1px solid #000">' + na(project.owner) + '</td><td style="font-weight:bold;padding:2px 4px;border-bottom:1px solid #ccc">HRG Project No:</td><td style="padding:2px 4px;border-bottom:1px solid #ccc">' + na(project.project_number) + '</td></tr>'
    + '<tr><td style="font-weight:bold;padding:3px 6px">Re:</td><td style="padding:2px 4px;border-right:1px solid #000">' + na(report.re) + '</td><td style="font-weight:bold;padding:2px 4px">Date:</td><td style="padding:2px 4px">' + reportDate + (weekday ? ' (' + weekday + ')' : '') + '</td></tr>'
    + '</tbody></table>'
